...
| :--- | :---: | :---- | :--- | :--- | :---- |
| 2013 | 🔳 | [LReLU](components/LReLU.md) | [paper](https://ai.stanford.edu/~amaas/papers/relu_hybrid_icml2013_final.pdf) | v6 | Rectifier Nonlinearities Improve Neural Network Acoustic Models |
...
| 2016 | 🔳 | [Dice Loss](components/DiceLoss.md) | [paper](https://arxiv.org/pdf/1606.04797) | RTMDet | V-Net: Fully Convolutional Neural Networks for Volumetric Medical Image Segmentation |
| 2017 | 🔳 | [Swish](components/Swish.md) | [paper](https://arxiv.org/pdf/1710.05941) | v6 | Searching for activation functions |
...
| 2017 | 🔳 | [Gradient Optimizers](components/GradientOptimizers.md) | [paper](https://arxiv.org/pdf/1609.04747) | All | An overview of gradient descent optimization algorithms |
...
| 2018 | 🔳 | [CornerNet](components/CornerNet.md) | [paper](https://arxiv.org/pdf/1808.01244) | v6 | CornerNet: Detecting Objects as Paired Keypoints |
| 2019 | 🔳 | [AdamW](components/AdamW.md) | [paper](https://arxiv.org/pdf/1711.05101) | RTMDet | Decoupled weight decay regularization |
...
| 2019 | 🔳 | [RepPoints](components/RepPoints.md) | [paper](https://arxiv.org/pdf/1904.11490) | v6 | RepPoints: Point Set Representation for Object Detection |
| 2019 | 🔳 | [Objects as points](components/ObjectsAsPoints.md) | [paper](https://arxiv.org/pdf/1904.07850) | v6 | Objects as Points |
...
| 2020 | 🔳 | [BlendMask](components/BlendMask.md) | [paper](https://arxiv.org/pdf/2001.00309) | v7 | BlendMask: Top-Down Meets Bottom-Up for Instance Segmentation |
| 2020 | 🔳 | [Conditional Conv](components/ConditionalConv.md) | [paper](https://arxiv.org/pdf/2003.05664) | RTMDet | Conditional Convolutions for Instance Segmentation |
| 2020 | 🔳 | [DFLv2](components/DFLv2.md) | [paper](https://arxiv.org/pdf/2011.12885) | v6 | Generalized Focal Loss V2: Learning Reliable Localization Quality Estimation for Dense Object Detection |
...
| 2021 | 🔳 | [Alpha-IoU](components/Alpha-IoU.md) | [paper](https://arxiv.org/pdf/2110.13675) | v6 | Alpha-IoU: A Family of Power Intersection over Union Losses for Bounding Box Regression |
