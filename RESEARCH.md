...
* **Enhance receptive field**
	...
	* **Atrous Spatial Pyramid Pooling** ([ASPP](5)) - exploits multi-scale features by employing multiple dilated convolutions with $kernel\_size = 3 × 3$, $dilated\_ratio = k$, $stride = 1$
