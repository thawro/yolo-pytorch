...
where σ denotes the sigmoid function, W0 has shape _C/r×C_, and _W1_ has shape _C×C/r_. Note that the MLP weights, _W0_ and _W1_, are shared for both inputs and the ReLU activation function is followed by _W0_.
